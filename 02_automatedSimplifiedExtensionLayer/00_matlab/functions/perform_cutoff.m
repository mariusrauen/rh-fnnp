function [Model,Cutoff] = perform_cutoff(Model,file,cutoff_rule_cumulated,cutoff_rule)
...
% Cutoff_final.matrices.A.std_dev(Cutoff.rows_to_delete,:)= [];
% Cutoff_final.matrices.A.distr_type(Cutoff.rows_to_delete,:)= [];
% Cutoff_final.matrices.A.row_names(Cutoff.rows_to_delete,:)= [];

% Modify Vector y
% Cutoff_final.matrices.y.mean_values(Cutoff.rows_to_delete,:) = [];
% Cutoff_final.matrices.y.std_dev(Cutoff.rows_to_delete,:)= [];
% Cutoff_final.matrices.y.distr_type(Cutoff.rows_to_delete,:)= [];
% Cutoff_final.matrices.y.row_names(Cutoff.rows_to_delete,:)= [];

%% List all flows deleted in matlab
Cutoff_final.cutoff.A=A_mean_cutoff;
% Cutoff_final.cutoff.y=y_cutoff;
Cutoff_final.cutoff.meta_data=meta_data_cutoff;

%% Create hybrid matrices

Cutoff_final.hybrid.A_hybrid=[];
% Cutoff_final.hybrid.y_hybrid=[];
...
%         Cutoff_final.hybrid.y_hybrid(end+1,:)=Cutoff_final.matrices.y.mean_values(i,:);
...
% Cutoff_final.hybrid.y_hybrid=[Cutoff_final.hybrid.y_hybrid;y_cutoff];
Cutoff_final.hybrid.meta_data_hybrid=[Cutoff_final.hybrid.meta_data_hybrid;meta_data_cutoff(2:end,:)];

%clear A_mean_cutoff y_cutoff meta_data_cutoff
...
% Cutoff_final.matrices.A.std_dev(found_rows_hybrid,:)= [];
% Cutoff_final.matrices.A.distr_type(found_rows_hybrid,:)= [];
% Cutoff_final.matrices.A.row_names(found_rows_hybrid,:)= [];


% Modify Vector y
% Cutoff_final.matrices.y.mean_values(found_rows_hybrid,:) = [];
% Cutoff_final.matrices.y.std_dev(found_rows_hybrid,:)= [];
% Cutoff_final.matrices.y.distr_type(found_rows_hybrid,:)= [];
% Cutoff_final.matrices.y.row_names(found_rows_hybrid,:)= [];
...
%  Cutoff_final.hybrid.y_hybrid_dollar=Cutoff_final.hybrid.y_hybrid;
