function [list_layer_2] = get_list_layer_2(Model, database_scope)
...
rows_layer_2 = find(cell2mat(database_scope(2:end,7))==2);
main_flows =  database_scope(rows_layer_2+1,3);
