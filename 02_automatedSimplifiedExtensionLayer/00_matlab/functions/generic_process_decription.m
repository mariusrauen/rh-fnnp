function [Model] = generic_process_decription(Model)
...
BackgroundModelling = "Background modeling: " + ...
    newline + "The data set represents a cradle to gate inventory, including all relevant process steps / technologies over the supply chain. The data set is based on different types of data: Process data is obtained from detailed process simulations. International trade volumes and regional production capacities are mainly based on primary data and complemented by secondary data where necessary." + ...
...
for i = 1:AmountProcesses
    ...
    ProcessDescription = append(String1,String2,String3,String4,String5,newline,BackgroundModelling);
