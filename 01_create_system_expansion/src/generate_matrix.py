...
def get_all_mols(df: pd.DataFrame)->list[str]:
    ...
    allmols.append(df['co-product 4'].to_list())
    allmols.append(df['co-product 5'].to_list())
    allmols.append(df['co-product 6'].to_list())
    allmols.append(df['co-product 7'].to_list())
